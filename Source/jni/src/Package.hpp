...
private:
	...
	/// </summary>
	/// <param name="path">The path to save to.</param>
	void SaveStructs(std::string path) const;

	/// <summary>
	/// Writes all classes into the appropriate file.
	/// </summary>
	/// <param name="path">The path to save to.</param>
	void SaveClasses(std::string path) const;

	/// <summary>
	/// Writes all functions into the appropriate file.
	/// </summary>
	/// <param name="path">The path to save to.</param>
	void SaveFunctions(std::string path) const;

	/// <summary>
	/// Writes all function parameters into the appropriate file.
	/// </summary>
	/// <param name="path">The path to save to.</param>
	void SaveFunctionParameters(std::string path) const;
